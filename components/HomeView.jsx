  ...
  return (
    <View className="flex-1 pt-16 px-4 bg-[#055B72]">
      ...
      <View className="flex-row items-center gap-2">
        <View className="w-10 h-10 bg-[#044454] rounded-full"></View>
      ...
      <View className="flex-1 mt-8 px-4 justify-between max-h-[312px] py-4 boder border-white rounded-lg">
        ...
        <StyledPressable
          className={`p-4 rounded-lg active:opacity-60 bg-[#79C72B]`}
        >
          <Text className="text-center font-semibold text-sm text-[#055B72]">
            Pedi un prestamo
          </Text>
        </StyledPressable>
      </View>
